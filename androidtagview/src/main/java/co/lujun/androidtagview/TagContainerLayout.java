...
public class TagContainerLayout extends ViewGroup {
  ...
  private void init(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    mHorizontalInterval =
        (int) attributes.getDimension(R.styleable.AndroidTagView_horizontal_interval,
            dp2px(context, DEFAULT_INTERVAL));
    ...
    mRippleColor = attributes.getColor(R.styleable.AndroidTagView_tag_ripple_color,
        Color.parseColor("#EEEEEE"));
    mRippleAlpha = attributes.getInteger(R.styleable.AndroidTagView_tag_ripple_alpha, mRippleAlpha);
    mRippleDuration =
        attributes.getInteger(R.styleable.AndroidTagView_tag_ripple_duration, mRippleDuration);
    ...
    mCrossBgColor =
        attributes.getColor(R.styleable.AndroidTagView_tag_cross_bg_color, mCrossBgColor);
    ...
    mTagSupportLettersRTL =
        attributes.getBoolean(R.styleable.AndroidTagView_tag_support_letters_rlt,
            mTagSupportLettersRTL);
  ...
  private int getChildLines(int childCount) {
    ...
    return mMaxLines <= 0 || lines < mMaxLines ? lines : mMaxLines;
  }
  ...
  private int[] onUpdateColorFactory() {
    ...
    if (mTheme == ColorFactory.RANDOM) {
      ...
      colors = new int[] {
          mTagBackgroundColor, mTagBorderColor, mTagTextColor, mSelectedTagBackgroundColor
      };
    }
    return colors;
  }
